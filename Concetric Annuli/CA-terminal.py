...
class Net(nn.Module):
    def __init__(self, odefunc):
        ...
        self.t1 = nn.Parameter(torch.tensor(1.), requires_grad=True)
        # self.n_steps = 100
        self.dt = 0.01
    ...
    def forward(self, x):
        ...
        y = odeint(self.odefunc, y0, t_seq, method='rk4')
        return t_seq, y
...
class Learner(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        # print(t_eval[-1])
        y_hat = y_hat[-1][:,:-1] # select last point of solution trajectory
...
# torch.save(Net.state_dict(), 'augmented_CM_T_rk4fix_terminal_from1.pt')

# Net.load_state_dict(torch.load('augmented_CM_T_rk4.pt'))
